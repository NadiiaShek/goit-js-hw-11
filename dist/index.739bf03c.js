...
btnSearch.addEventListener("click", (e)=>{
    ...
    if (trimmedValue !== "") (0, _fetchImages.fetchImages)(trimmedValue, pageNumber).then((foundData)=>{
        if (foundData.hits.length === 0) (0, _notiflixDefault.default).Notify.failure("Sorry, there are no images matching your search query. Please try again.");
        else {
            renderImageList(foundData.hits);
            (0, _notiflixDefault.default).Notify.success(`Hooray! We found ${foundData.totalHits} images.`);
...
btnLoadMore.addEventListener("click", ()=>{
    ...
    const trimmedValue = input.value.trim();
    btnLoadMore.style.display = "none";
    (0, _fetchImages.fetchImages)(trimmedValue, pageNumber).then((foundData)=>{
        if (foundData.hits.length === 0) (0, _notiflixDefault.default).Notify.failure("Sorry, there are no images matching your search query. Please try again.");
        else {
            renderImageList(foundData.hits);
            (0, _notiflixDefault.default).Notify.success(`Hooray! We found ${foundData.totalHits} images.`);
...
},{"../js/fetchImages":"dOg5x","notiflix":"5WWYd","simplelightbox":"9ydBq","simplelightbox/dist/simple-lightbox.min.css":"kaxSc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dOg5x":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "fetchImages", ()=>fetchImages);
const fetchImages = async (inputValue, pageNr)=>{
    return await fetch(`https://pixabay.com/api/?key=29588079-fbc492831fdad231bf7222b96&q=${inputValue}&orientation=horizontal&safesearch=true&image_type=photo&per_page=40&page=${pageNr}`).then(async (response)=>{
        if (!response.ok) {
